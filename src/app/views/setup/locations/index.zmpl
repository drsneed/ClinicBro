  ...
  <div class="setup-screen">
    <div class="setup-item-menu">
      ...
      <div class="setup-button-bar" hx-ext="path-params">
        <button type="button" class="btn btn-cancel" title="Add New"
        ...
        <button type="button" class="btn btn-cancel" title="Save"
        ...
        <button type="button" class="btn btn-cancel" title="Delete"
