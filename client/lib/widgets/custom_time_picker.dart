...
String _formatMinute(int minute, String locale) {
  ...
  return DateFormat('mm', locale).format(DateTime(
    0, // year
    0, // month
    0, // day
    0, // hour,
  ...
  Widget build(BuildContext context) {
    ...
    Widget picker = Picker(
      ...
      pickerContent: (context) {
        return _CustomTimePickerContentPopup(
...
class _CustomTimePickerContentPopup extends StatefulWidget {
  const _CustomTimePickerContentPopup({
    required this.date,
  ...
  @override
  State<_CustomTimePickerContentPopup> createState() =>
      __CustomTimePickerContentPopupState();
}

class __CustomTimePickerContentPopupState
    extends State<_CustomTimePickerContentPopup> {
